...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
   ...
   " Todo
   """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
   au BufNewFile,BufRead *.todo so ~/dotfiles/.vim/syntax/amido.vim
   ...
   au FileType python so ~/dotfiles/.vim/syntax/python.vim
   autocmd FileType python map <buffer> <leader><space> :w!<cr>:!python %<cr>
   autocmd FileType python so ~/dotfiles/.vim/plugin/python_fold.vim
   ...
   "Java comments
   autocmd FileType java source ~/dotfiles/.vim/macros/jcommenter.vim
   ...
   " JavaScript section
   """""""""""""""""""""""""""""""
   au FileType javascript so ~/dotfiles/.vim/syntax/javascript.vim
